...
export class QuestionService {
    ...
    private resourceFullInfoBySubLessonUrl =  SERVER_API_URL + 'api/questionsFullInfoBySubLesson';
    ...
    queryFullInfoBySubLesson(id: number, req?: any): Observable<ResponseWrapper> {
        const options = createRequestOption(req);
        return this.http.get(this.resourceFullInfoBySubLessonUrl + '/' + id, options)
            .map((res: Response) => this.convertResponse(res));
    }
     ...
     * Convert a returned JSON object to Question.
     */
    private convertItemFullInfoFromServer(json: any): QuestionFull {
        const entity: QuestionFull = Object.assign(new QuestionFull(), json);
        entity.createDate = this.dateUtils
            .convertDateTimeFromServer(json.createDate);
        return entity;
    }
    private convertFullInfo(question: QuestionFull): QuestionFull {
        const copy: QuestionFull = Object.assign({}, question);
