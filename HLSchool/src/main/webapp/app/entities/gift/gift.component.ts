...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/gift'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    registerChangeInGifts() {
        this.eventSubscriber = this.eventManager.subscribe('giftListModification', (response) => this.loadAll());
    }
