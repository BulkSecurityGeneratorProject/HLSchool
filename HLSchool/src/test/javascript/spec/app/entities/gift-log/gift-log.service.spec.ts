...
describe('Service Tests', () => {
    ...
    describe('GiftLog Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(GiftLogService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/gift-logs';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return GiftLog', () => {

                let entity: GiftLog;
                service.find(123).subscribe((_entity: GiftLog) => {
                    entity = _entity;
                });
