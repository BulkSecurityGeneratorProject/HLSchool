...
describe('Service Tests', () => {
    ...
    describe('Vocabulary Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(VocabularyService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/vocabularies';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Vocabulary', () => {

                let entity: Vocabulary;
                service.find(123).subscribe((_entity: Vocabulary) => {
                    entity = _entity;
                });
